...
describe('useCurrentProduct', () => {
  it('should return portal values', () => {
    ...
    expect(typeof result.current.currentProduct).toBe('object')
  })
  ...
  it('should return currentProduct type', () => {
    const store = makeStore({
      app: appValues,
      flow: flowValues,
      global: globalValues,
    ...
    expect(result.current.currentProduct).toBeDefined()
    expect(result.current.currentProduct).toHaveProperty('assistances')
    expect(result.current.currentProduct).toHaveProperty('benefits')
    expect(result.current.currentProduct).toHaveProperty('code')
    expect(result.current.currentProduct).toHaveProperty('coverages')
    expect(result.current.currentProduct).toHaveProperty('exclusions')
    expect(result.current.currentProduct).toHaveProperty('insuranceName')
    expect(result.current.currentProduct).toHaveProperty('plans')
    expect(result.current.currentProduct).toHaveProperty('portal')
  })
})
